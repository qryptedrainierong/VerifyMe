...
export const platformEndUserAssociations: PlatformEndUserAssociation[] = [
  ...
  {
    id: "link-usr-org001-demo-risk",
    verifymeUserId: "a0000014-0000-4000-8000-000000000014",
    verifymeId: "vmorgdemo99",
    email: "org-demo-risk@example.com",
    clientUserId: "cust_acme_orgdemo_risk",
    organization: "Acme Corporation",
    organizationId: "ORG-001",
    status: "active",
    verificationSessions: 120,
    lastActive: "2024-04-09T09:00:00",
    created: "2024-03-01",
    device: d("Pixel 8", "Android", "active", "2024-03-01T10:00:00Z", "2024-04-09T09:00:00Z", "Bound · elevated risk demo"),
  },
  {
