...
const rawOrganizations: PlatformOrganization[] = [
  ...
  },
  {
    ...
    organizationCode: "NORTH",
    primaryClientId: "NORTH_CALLCENTER_PROD_001",
    organizationType: "Enterprise",
    industry: "Retail",
    companySize: "201-500",
    country: "Canada",
  ...
  },
  {
    ...
    legalName: "Contoso Retail GmbH",
    domain: "contoso.example",
    organizationCode: "CONTOSO",
    primaryClientId: "CONTOSO_MESSAGING_PROD_001",
    organizationType: "Enterprise",
    industry: "Retail",
    companySize: "1001-5000",
    country: "Germany",
