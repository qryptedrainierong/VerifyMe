...
const rawSessions: MockVerificationSession[] = [
  ...
  },
  {
    ...
    tokenExchangeStatus: "not_started",
    idTokenIssued: false,
    failureReason: "System/API fault after authorize — no billable proof result.",
  ...
  },
  {
    ...
    customerDisplayName: "Jordan Park",
    maskedVerifymeId: "vm91b3c4",
    nameConsistency: "strong_match",
    status: "failed",
    outcome: "failed",
    ...
    tokenExchangeStatus: "not_started",
    idTokenIssued: false,
    failureReason: "Submitted proof did not validate (single attempt).",
    sessionContextRiskLevel: "Low",
    operatorScenarioNote: "ID Proof Fail — isolated attempt with low user risk.",
    timeline: [
